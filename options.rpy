...
init -1 python hide:
    ...
    config.window_title = u"И мир был создан для нас"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "And world was created for us"
    config.version = "0.1"
    ...
    #style.window.background = "ui/dialogue/textbox.png"
...
python early:
    config.save_directory = "AWWCFU-1393214415"
...
init -1 python hide:
    ...
    style.say_label.font = "Dally.ttf"
    style.say_label.size = 55
    style.say_label.drop_shadow = [(1,1)]
    style.say_label.bold = False
    
    style.say_dialogue.font = "Dally.ttf"
    style.say_dialogue.size = 27
    style.say_dialogue.drop_shadow = [(1,1)]
    
    style.say_vbox.top_margin = 250
    
    style.menu_choice.size = 55
    style.menu_choice.color = "#2ccbd9"
    
    style.menu_choice.font = "Fox.ttf"
    style.menu_choice.hover_color = "#fff"
    style.menu_choice.drop_shadow = [(1,1)]
    
    style.menu_choice_button.background = Frame("ui/blank.png",28,9)
    style.menu_choice_button.hover_background = Frame("ui/blank.png",28,9)
